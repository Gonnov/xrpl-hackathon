...
export const PaymentPage = () => {
  ...
  const { details, partner, setEscrowFunded, userRole } = useTransactionStore();

  useEffect(() => {
    if (userRole !== 'Importer' || details.fundingMethod !== 'self') {
      navigate('/dashboard');
    }
        ...
        <main className="flex-1 flex flex-col bg-[#f9fafb]">
          ...
          <div className="flex-1 px-6 pb-6 overflow-auto">
            <div className="max-w-3xl mx-auto space-y-6">
              {/* Header */}
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">Fund Escrow</h1>
                <p className="mt-1 text-sm text-gray-500">
                  Review the transaction details and fund the escrow account to proceed with the trade.
                </p>
              </div>
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">{partner.country}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                    ...
                    <div className="flex items-center gap-2 text-emerald-600">
                      ...
                      <span className="text-sm font-medium">Secured by KAYP Escrow</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-600">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Deadline to fund: March 20, 2025</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <FileText className="w-4 h-4" />
                      <span>Transaction ID: TR-2024-004</span>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          Your payment is protected until all documents are verified and goods are confirmed shipped.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">
                          Funds are automatically released to the exporter once shipping documents are verified.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-xs">
                          <p>
                            Escrow is a financial arrangement where a third party holds and regulates 
                            payment of funds for two parties who are in the process of completing a transaction.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
      ...
      <Dialog open={showConfirmation} onOpenChange={setShowConfirmation}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to fund the escrow for this transaction? 
              Funds will be held securely until shipment is confirmed.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="bg-amber-50 p-4 rounded-lg flex items-start gap-3">
            ...
            <div className="text-sm text-amber-700">
              <p className="font-medium">Please confirm your action</p>
              <p className="mt-1">
                You are about to transfer {formattedAmount} to the escrow account. 
